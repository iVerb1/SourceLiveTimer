...
namespace SourceLiveTimer.SourceSplit
{
    class GameMemory
    {
        ...
        private string[] GameProcesses = new string[] {"hl2.exe", "portal2.exe", "dearesther.exe"};
        ...
        {
            string[] procs = GameProcesses.Select(x => x.ToLower().Replace(".exe", String.Empty)).ToArray();
